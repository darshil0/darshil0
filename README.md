...
| **Frameworks** | Regression, SIT, Exploratory, E2E, API, Database, Web Services |
...
* **Cost Efficiency:** Delivered a **40% reduction in patient care costs** through Shift-Left and Risk-Based Testing.
* **Operational Speed:** Improved patient wait times by **30%** by streamlining QA workflows and automation coverage.
* **Team Leadership:** Led and mentored **global teams of 15+ engineers** across multiple time zones at Accenture.
* **Regulatory Excellence:** Achieved **100% compliance rates** across HIPAA, FDA, and ISO audits for safety-critical systems.
* **Innovation:** Pioneered LLM-based clinical validation systems to detect medical data compliance violations before production.
